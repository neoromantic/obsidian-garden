---
{"dg-publish":true,"permalink":"/inbox/testirovanie-v-dbt/"}
---
...
- [A comprehensive guide to managing data quality with dbt tests | by NULLIF() - An analytics engineering blog | Dev Genius](https://blog.devgenius.io/a-comprehensive-guide-to-automating-data-testing-in-dbt-a1ca8a1d588c)
...
- [Building a Data Platform in 2024. How to build a modern, scalable data… | by Dave Melillo | Feb, 2024 | Towards Data Science](https://towardsdatascience.com/building-a-data-platform-in-2024-d63c736cccef)
...
- [Data quality testing: Where and why you should have it](https://www.getdbt.com/blog/data-quality-testing)
- [Data Quality with DBT Tests and Great Expectations | by Shehroz Abdullah | Medium](https://medium.com/@shehroz1447/data-quality-with-dbt-tests-and-great-expectations-b349634089bf)
...
- [dbt meta testing - Package hub](https://hub.getdbt.com/tnightengale/dbt_meta_testing/latest/)
- [dbt Testing Tools Gap | Infinite Lambda](https://infinitelambda.com/dbt-testing-tools-gap/)
...
- [dbt tips and tricks | dbt Developer Hub](https://docs.getdbt.com/docs/build/dbt-tips)
- [Enhance your dbt Data Monitoring with Elementary](https://blog.ippon.tech/enhance-your-dbt-data-monitoring-with-elementary)
- [Get deeper observability into your dbt pipelines  | Hightouch](https://hightouch.com/playbooks/dbt-pipeline-observability)
- [GitHub - bruno-uy/dbt-data-quality: Data quality checks in your dbt flow](https://github.com/bruno-uy/dbt-data-quality)
